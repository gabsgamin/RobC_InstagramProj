...
//@synthesize arrSelectedMedia = _arrSelectedMedia;

//NSMutableArray *arrSelectedMedia = [[NSMutableArray alloc] init];
NSMutableArray *arrSelectedMedia;
...
- (id)initWithAttributes:(NSDictionary *)attributes {
    ...
    arrSelectedMedia = [[NSMutableArray alloc] init];
...
{
    NSDictionary* params = [NSDictionary dictionaryWithObject:accessToken forKey:@"access_token"];
    NSString* path = [NSString stringWithFormat:kUserFeed];
