...
- (void)loadView
{
    ...
    dispatch_async(queue, ^ {
        ...
        dispatch_async(dispatch_get_main_queue(), ^ {
            ...
            UISwitch* toggleSwitch = [[UISwitch alloc] initWithFrame:CGRectMake(bounds.origin.x + 80,bounds.size.height - 50,100,50)];
...
- (void) switchChanged:(id)sender 
{
    ...
    if(switchControl.on)
    {
        [arrSelectedMedia addObject:self.media];
    }
    NSLog(@"Count %d",arrSelectedMedia.count);
