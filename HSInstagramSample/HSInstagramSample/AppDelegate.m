...
//  HSInstagramSample
//
//  Created by Harminder Sandhu on 12-01-19.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    HSMyMediaViewController* objMyMedia = [[HSMyMediaViewController alloc] init];
    UINavigationController* navigation = [[UINavigationController alloc] initWithRootViewController:objMyMedia];
